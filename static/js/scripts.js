...
function initOutdoor() {
    ...
    function a() {
        ...
        var a = $(window).height(), b = $("header").outerHeight(), c = $("footer").outerHeight(),
            d = $(".port-subtitle-holder").outerHeight(), e = $(".p_horizontal_wrap");
        e.css("height", a - b - c - 20);
    ...
    d();
    //swiper  ------------------
    var mouse_wheel = $('#horizontal-slider').data('mouse-wheel');
    var f = new Swiper("#horizontal-slider", {
        speed: 1200,
        loop: false,
        grabCursor: true,
        mousewheel: mouse_wheel ? mouse_wheel : false,
    ...
    function initGalleryhorizontal() {
        var a = $(window).height(), c = $("header").outerHeight(), d = $("footer").outerHeight(),
...
//________________________bellow scripts add by backendDEV______________________________
